...
@section('main')
          <form method="post" action="thing_register_check.html" id="regF">
            <div class="thing_change">
              <div class="thing_change_text">
                <p style="">登録内容を変更する場合、変更箇所を訂正し〔入力確認〕を押してください。</p>
              </div>
              <table>
                <tr>
                  <th><p class="th_p">認定番号</p></th>
                  <td class="code">
                    <input type="hidden" name="construction_no" value="{{ $construction->construction_no }}" />
                    <input type="hidden" name="construction_eda" value="{{ $construction->construction_eda }}" />
...
@endforeach
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="year" id="year" size="20" maxlength="2" />
                  </td>
                </tr>
                <tr>
...
@foreach ( $constructors as $constructor )
                      <option value="{{ pad3($constructor->company_code) }}">{{ $constructor->company_name }}</option>
@endforeach
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="code">
                    1{{ pad3($construction->company_seq) }}
                  </td>
                </tr>
                <tr>
                  <th></th>
...
@foreach ( $designers as $designer )
                      <option value="{{ pad3($designer->company_code) }}">{{ $designer->company_name }}</option>
@endforeach
                    </select>
                  </td>
                </tr>
...
@endforeach
              ...
              <input class="thing_change_button" id="thing_change_button" type="button" name="submit" />
            </div>
          </form>
