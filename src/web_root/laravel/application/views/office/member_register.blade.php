...
@section('main')
          <form method="post" action="member_register_check.html" id="regF">
            <div class="member_register">
              <div class="member_register_text">
                <p style="p_subject">全ての項目を入力し〔入力確認〕を押してください。</p>
              </div>
              <table>
                <tr>
                  <th><p class="th_p">会社コード</p></th>
                  <td>
                    <input type="text" name="company_code" size="4" id="company_code" />
                  </td>
                </tr>
                <tr>
...
@endfor
              ...
              <input class="member_register_button" id="member_register_button" type="button" name="submit" />
            </div>
          </form>
@endsection