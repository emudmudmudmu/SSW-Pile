...
@section('main')
          ...
          <form method="post" action="thing_register_finish.html" id="regF">
            <div class="thing_register_check">
              <table>
                <tr>
                  <th><p class="th_p">認定番号</p></th>
                  <td class="code">
                    <input type="hidden" name="year" value="{{ $input['nendo'] }}" />
                    <input type="hidden" name="construction_company" value="{{ $input['construction_company'] }}" id="constructor" />
                    <span id="constructionNo"></span>
                  </td>
                </tr>
                <tr>
                  <th class="n_th"></th>
                ...
                <tr>
                  ...
                  <td>
                    <span id="company_seq" class="code"></span>
                  </td>
                </tr>
                <tr>
                  <th class="n_th"></th>
