...
@endforeach
              ...
              <input class="register_button" type="button" id="register_button" >
            </div>
...
@foreach( $result as $r )
                <tr>
                  ...
                  <td align="center" nowrap><a href="{{ URL::to("construction/{$r->construction_no}/{$r->construction_eda}/thing_change.html") }}">変更</a></td>
                </tr>
@endforeach
              </table>
            </div>
