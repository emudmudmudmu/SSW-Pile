...
<link type="text/css" href="/css/page_private_parts.css" rel="stylesheet" media="all" />
{{ Asset::styles() }}
<!-- InstanceEndEditable -->
...
<div id="container"><!-- InstanceBeginEditable name="main" -->
  <div id="maincolumn" class="clearfix">
    <img src="/images/private/page_logo3.png" style="margin-left: 10px; margin-top: -20px;"/>
    <div class="section clearfix">
      <div class="private">
        <div class="sidebar">
          <p class="link_header">先端パーツ受注管理</p>
            <p class="link"><a href="{{ URL::to('parts/slip_search.html') }}">伝票発行/出荷処理</a></p>
          <br>
