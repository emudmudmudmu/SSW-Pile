...
<link type="text/css" href="/css/page_private.css" rel="stylesheet" media="all" />
{{ Asset::styles() }}
<!-- InstanceEndEditable -->
...
<div id="container"><!-- InstanceBeginEditable name="main" -->
  <div id="maincolumn" class="clearfix">
    <img src="/images/private/page_logo.png" style="margin-left: 10px; margin-top: -20px;"/>
    <div class="section clearfix">
      <div class="private">
        <div class="sidebar">
          <p class="link"><a href="{{ URL::to('construction/roster.html') }}">指定施工会社名簿</a></p>
          <p class="link"><a href="{{ URL::to('construction/thing_query.html') }}">物件照会</a></p>
          <p class="link"><a href="{{ URL::to('construction/style_download.html') }}">様式ダウンロード</a></p>
          <img class="line" src="/images/private/sidebar_line.png"/>
          <p class="link"><a href="{{ URL::to('construction/thing_search.html') }}">物件登録</a></p>
          <p class="link"><a href="{{ URL::to('construction/parts_order.html') }}">パーツ発注</a></p>
          <p class="link"><a href="{{ URL::to('construction/parts_order_history.html') }}">パーツ発注履歴</a></p>
          <p class="link"><a href="{{ URL::to('construction/receipt_billing_history.html') }}">受取請求履歴</a></p>
          <p class="link"><a href="{{ URL::to('construction/member_change.html') }}">会員登録情報変更</a></p>
          <br>
          <div class="top_logout">
            <p class="link2"><img class="home" src="/images/private/home.png"/><a href="{{ URL::to('construction/top.html') }}">トップページ</a></p>
