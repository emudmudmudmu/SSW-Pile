<?php
// 定数
include_once path('app') . 'constants.php';

// ヘルパ関数
include_once path('app') . 'helper.php';
...
Autoloader::map(array(
	...
	'Office_Base_Controller'       => path('app') . 'controllers/office/base.php',
	'Construction_Base_Controller' => path('app') . 'controllers/construction/base.php',
	'Parts_Base_Controller'        => path('app') . 'controllers/parts/base.php',
));
