if ($.fn.pagination){
	...
	$.fn.pagination.defaults.displayMsg = '{from} bis {to} von {total} Datensﾃ､tzen';
}
if ($.fn.datagrid){
	$.fn.datagrid.defaults.loadMsg = 'Verarbeitung lﾃ､uft, bitte warten ...';
}
...
if ($.fn.validatebox){
	...
	$.fn.validatebox.defaults.rules.email.message = 'Bitte geben Sie eine gﾃｼltige E-Mail-Adresse ein.';
	$.fn.validatebox.defaults.rules.url.message = 'Bitte geben Sie eine gﾃｼltige URL ein.';
...
if ($.fn.calendar){
	...
	$.fn.calendar.defaults.months = ['Jan', 'Feb', 'Mﾃ､r', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez'];
}
if ($.fn.datebox){
	$.fn.datebox.defaults.currentText = 'Heute';
	$.fn.datebox.defaults.closeText = 'Schlieﾃ歹n';
